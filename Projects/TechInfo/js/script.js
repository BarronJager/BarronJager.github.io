...
const quotesTimer = setInterval(displayQuotesPanel, 10000)
...
const featuredTechnologyTimer = setInterval(displayFeaturedTechnologyPanel, 20000)
...
const featuredTechnologyTimer2 = setInterval(displayFeaturedTechnologyPanel2, 15000)

// Create a new timer using setInterval and assign it to the variable 'infoTimer'. Have the timer fire off every 5 seconds
const infoTimer = setInterval(displayinfoPanel, 5000)
...
const socialMediaTimer = setInterval(displaySocialMediaPanel, 5000)
