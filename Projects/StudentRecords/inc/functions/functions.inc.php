...
function display_record_table($records)
{
    ...
    echo '<thead class="table-dark"><tr><th class="bg-primary">Actions</th><th><a href="?sortby=student_id">Student ID</a></th><th><a href="?sortby=first_name">First Name</a></th>
        <th><a href="?sortby=last_name">Last Name</a></th><th><a href="?sortby=email">Email</a></th><th><a href="?sortby=phone">Phone</a></th>
        <th><a href="?sortby=gpa">GPA</a></th><th class="text-center"><a href="?sortby=financial_aid">Financial Aid</a></th><th><a href="?sortby=degree_program">Degree Program</a></th>
    ...
    foreach ($records as $row) {
        ...
        echo "<td class=\"text-center\">{$fin_aid_text}</td>";
        ...
        if (!empty($row->graduation_date)) {
            $formatted_graduation_date = date_format(date_create($row->graduation_date), "m/d/Y");
        }
        echo "<td>{$formatted_graduation_date}</td>";
        echo '</tr>';
    } // end while
    echo '</table>';
    echo '</div>';
